 ...
 */
  ...
  public function init_widgets() {
    ...
    require_once( __DIR__ . '/widgets/banner-section.php' );
		require_once( __DIR__ . '/widgets/marqueue-section.php' );
		require_once( __DIR__ . '/widgets/features-section.php' );
		require_once( __DIR__ . '/widgets/list-section.php' );
    require_once( __DIR__ . '/widgets/Testimonials.php' );
    require_once( __DIR__ . '/widgets/Cards-section.php' );
